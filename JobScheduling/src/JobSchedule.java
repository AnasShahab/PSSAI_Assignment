...
public class JobSchedule{
    public static void main(String[] args)throws Exception{
		...
		Scanner s = new Scanner(new File("C:\\Users\\ASUS\\Desktop\\PSSAI_Ass\\Assignment\\src\\input.txt"));
		totalJobs = Integer.parseInt(s.next());
		totalMach = Integer.parseInt(s.next());
		s.nextLine();

		Scanner sc = new Scanner(new File("C:\\Users\\ASUS\\Desktop\\PSSAI_Ass\\Assignment\\src\\input.txt"));
		sc.nextLine();
		...
		*/
		...
		//Integer numOfChanges = (int) Math.round(totalJobs * totalMach * 0.1);
